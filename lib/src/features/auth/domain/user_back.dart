...
//   @override
//   String toString() {
//     return 'User(idx: $idx, name: $name, email: $email, phone: $phone, profilePic: $profilePic, primaryRole: $primaryRole, roles: $roles, additionalAttributes: $additionalAttributes)';
//   }
